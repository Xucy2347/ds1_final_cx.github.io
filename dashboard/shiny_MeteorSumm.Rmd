...
runtime: shiny
resource_files:
  - dashboard/data/NYcounty_fips/*
  - dashboard/data/meteor_2016to20_NY.csv
---
...
NYcounty_sf <- sf::read_sf(here::here("dashboard", "data", "NYcounty_fips", "NYcounty_fips.shp"))

NYcounty_df = NYcounty_sf |> st_drop_geometry()

meteor_r <- read_csv(here::here("dashboard", "data", "meteor_2016to20_NY.csv")) |>
  mutate(
    year = year(date),
    tmmn_c = tmmn - 273.15,
    tmmx_c = tmmx - 273.15,
