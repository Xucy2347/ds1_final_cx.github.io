...
runtime: shiny
resource_files:
  - dashboard/df_gen/data/NYcounty_fips/*
  - dashboard/df_gen/data/meteor_2016to20_NY.csv
---

```{r}
message("THIS FILE IS BEING RENDERED: ", normalizePath("shiny_MeteorSumm.Rmd"))
```
...
NYcounty <- sf::read_sf("df_gen/data/NYcounty_fips/NYcounty_fips.shp") 
